...
def generate_slide10_charts(*, xlsx_path: Path, output_dir: Path) -> list[Path]:
    """Slide 10: gera 05, 06, 07 a partir da aba 'Qualidade Cart 2682'."""
    ...
    # 05) Varejo + Veiculos (Veiculos pontilhado)
    ...
    # 06/07) Total e Atacado (se achar pelo titulo; senao pega as restantes)
