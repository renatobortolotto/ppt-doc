...
SLIDE15_BAR_SLOT = 1.34
SLIDE15_BAR_WIDTH = 1.0
SLIDE15_INNER_LABEL_FONT_SCALE = 1.0
SLIDE15_BADGE_PAD = 0.10
SLIDE15_DELTA_PAIRS = ((0, 2), (1, 2))
SLIDE15_DELTA_BRACKET_COLORS = ("#123a7a", "#2f2f2f")
SLIDE15_DELTA_LABEL_X_FRACTIONS = (0.30, 0.50)
    ...
    *,
    ...
    if n >= 2:
        ...
        for level, (pi, ci) in enumerate(norm_pairs):
            prev = float(totals_per_bar[pi])
            curr = float(totals_per_bar[ci])
