...
from utils.slide14_charts import (
    _fmt_pct_trunc,
...
class TestSlide14Charts(unittest.TestCase):
    ...
    def test_generate_slide14_charts_uses_veiculos_ranges(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("utils.slide14_charts._plot_stacked_veiculos", side_effect=_capture_stacked):
                with patch("utils.slide14_charts._plot_percent_bars", side_effect=_capture_percent):
