...
from utils.slide19_charts import (
...
class TestSlide19Charts(unittest.TestCase):
    def test_generate_slide19_charts_uses_veiculos_ranges(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("utils.slide19_charts._plot_stacked_veiculos", side_effect=_capture_plot):
                with patch("utils.slide19_charts._plot_simple_bars", side_effect=_capture_simple):
