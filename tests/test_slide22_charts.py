...
from src.utils.slides.slide22_charts import (
    SLIDE22_CHARTS,
...
class TestSlide22Charts(unittest.TestCase):
    ...
    def test_generate_slide22_charts_uses_expected_ranges(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("src.utils.slides.slide22_charts._plot_stacked_pct_block", side_effect=_capture_plot):
                with patch("src.utils.slides.slide22_charts._plot_two_point_lines", side_effect=_capture_line_plot):
                    with patch("src.utils.slides.slide22_charts._plot_two_bar_values", side_effect=_capture_bar_plot):
